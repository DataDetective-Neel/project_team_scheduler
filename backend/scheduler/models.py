...
class Team:
    def __init__(self, team_id, students, faculty_id, duration, enrollment_number=""):
        self.team_id = team_id
        self.students = [Student(s) for s in students]
        self.faculty_id = faculty_id
        self.duration = duration  # minutes
        self.enrollment_number = enrollment_number.strip().upper() if enrollment_number else ""
